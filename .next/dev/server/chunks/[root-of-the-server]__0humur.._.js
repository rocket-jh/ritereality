...
"[project]/app/api/blog/categories/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const { categories } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$blog$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBlogCollections"])();
        const docs = await categories.find({}).sort({
            name: 1
        }).toArray();
...
async function POST(request) {
    try {
        ...
        const { categories } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$blog$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBlogCollections"])();
        const slug = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$blog$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slugify"])(name);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0humur.._.js.map